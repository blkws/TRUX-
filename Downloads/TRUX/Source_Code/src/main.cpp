...
#if defined(NDEBUG)
# error "GlobalTruckExchange cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "GlobalTruckExchange Signed Message:\n";
...
{
    RenameThread("globaltruckexchange-loadblk");
